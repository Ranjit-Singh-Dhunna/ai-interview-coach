    ...
    <div className={`interview-container${inInterview ? ' two-col' : ''}`}>
      ...
      {inInterview ? (
        ...
        <div className="welcome-screen">
          <div className="brand-hero" aria-label="INTERBU - AI Interview Coach">
            <img
              src="/logo-interbu.png"
              alt="INTERBU - AI Interview Coach"
                ...
                >
                  <div>
                    ...
                    <div className="folder">
                      <div className="top">
                        <svg viewBox="0 0 24 27" aria-hidden="true" focusable="false">
